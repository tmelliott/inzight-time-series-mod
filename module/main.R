TimeSeriesModule <- setRefClass(
    ...
    methods = list(
        initialize = function(gui, ...) {
            ...
            if (packageVersion("iNZightTS") >= numeric_version("1.6")) {
            ...
            midGrp <- ggroup(container = g_main, fill = TRUE)
            ...
            frames <- getToolkitWidget(g_main)$getChildren()
            g_main$set_rgtk2_font(frames[[1]]$getChildren()[[2]], frameFont)
            g_main$set_rgtk2_font(frames[[2]]$getChildren()[[2]], frameFont)
